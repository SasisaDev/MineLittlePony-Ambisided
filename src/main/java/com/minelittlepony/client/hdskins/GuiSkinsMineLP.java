...
class GuiSkinsMineLP extends GuiSkins {
    ...
    public void onSetLocalSkin(SkinType type) {
        ...
        MineLittlePonyClient.logger.debug("Invalidating old local skin, checking updated local skin");
    ...
    public void onSetRemoteSkin(SkinType type, Identifier location, MinecraftProfileTexture profileTexture) {
        ...
        MineLittlePonyClient.logger.debug("Invalidating old remote skin, checking updated remote skin");
        if (type == SkinType.SKIN) {
